...
<img src="/assets/img/blog/xexpectations.jpg" alt="Hope > Expectations > Desperation > Sadness"/>
...
Aren't these all related? As far as I think, anything first starts with *hope*, gradually our *expectations* increase, and when we come to know that it wouldn't be possible, then *desperation* starts.
Finally resulting in *sadness*.
...
The root for sadness is *hope* and *expectation*.
...
I am not saying that one is always bound with *happiness*.
*Unhappiness* is what makes *happiness* more interesting and tastier.
