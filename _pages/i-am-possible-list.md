...
.bl-progress-fill { height: 100%; width: 21%; background: linear-gradient(90deg, var(--bl-primary), var(--bl-primary-light)); border-radius: 100px; } /* 22/104 ≈ 21% */
...
<div class="bl-hero">
  ...
  <p class="bl-hero-count"><span>22</span> / 104</p>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    ...
    <div class="bl-item done"><div class="bl-item-num">24</div><div class="bl-item-content">Oktoberfest (Munich, Germany)<span class="bl-item-date">Done</span></div></div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">31</div><div class="bl-item-content">Learn Skiing (3 courses at IISM Gulmarg)<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item done"><div class="bl-item-num">32</div><div class="bl-item-content">Learn Surfing (Santander, Spain)<span class="bl-item-date">2012</span></div></div>
  </div>
  <div class="bl-achievement-card done">
  ...
  <div class="bl-items">
    ...
    <div class="bl-item done"><div class="bl-item-num">40</div><div class="bl-item-content">Desert dune bashing (self-drive)<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">41</div><div class="bl-item-content">Participate in Amazing Race</div></div>
    <div class="bl-item"><div class="bl-item-num">42</div><div class="bl-item-content">Cage diving with Great White Sharks</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-achievement-card done">
    ...
    <div class="bl-achievement-body">
      <div class="bl-achievement-num">43</div>
  ...
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">46</div><div class="bl-item-content">Run a Marathon</div></div>
    <div class="bl-item"><div class="bl-item-num">47</div><div class="bl-item-content">Spartan Trifecta</div></div>
    <div class="bl-item"><div class="bl-item-num">48</div><div class="bl-item-content">Run an Ironman</div></div>
    <div class="bl-item"><div class="bl-item-num">49</div><div class="bl-item-content">Learn BJJ — Get a medal in competition</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">50</div><div class="bl-item-content">Watch a Cricket Match at Lord's</div></div>
    <div class="bl-item done"><div class="bl-item-num">51</div><div class="bl-item-content">Attend Tennis Grand Slam Final<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">52</div><div class="bl-item-content">Attend Football World Cup</div></div>
    <div class="bl-item done"><div class="bl-item-num">53</div><div class="bl-item-content">Attend Cricket World Cup<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">54</div><div class="bl-item-content">Attend Olympics</div></div>
    <div class="bl-item"><div class="bl-item-num">55</div><div class="bl-item-content">Attend Super Bowl</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">56</div><div class="bl-item-content">Learn Salsa dancing</div></div>
    <div class="bl-item"><div class="bl-item-num">57</div><div class="bl-item-content">Learn a music instrument and perform</div></div>
    <div class="bl-item"><div class="bl-item-num">58</div><div class="bl-item-content">Learn to Juggle</div></div>
    <div class="bl-item"><div class="bl-item-num">59</div><div class="bl-item-content">Solve Rubik's Cube</div></div>
    <div class="bl-item"><div class="bl-item-num">60</div><div class="bl-item-content">Learn to cook an exquisite meal</div></div>
    <div class="bl-item"><div class="bl-item-num">61</div><div class="bl-item-content">Master chess (2000 rating)</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">62</div><div class="bl-item-content">English<span class="bl-item-date">Childhood</span></div></div>
    <div class="bl-item done"><div class="bl-item-num">63</div><div class="bl-item-content">Hindi<span class="bl-item-date">Childhood</span></div></div>
    <div class="bl-item"><div class="bl-item-num">64</div><div class="bl-item-content">Spanish</div></div>
    <div class="bl-item"><div class="bl-item-num">65</div><div class="bl-item-content">Mandarin</div></div>
    <div class="bl-item"><div class="bl-item-num">66</div><div class="bl-item-content">Arabic</div></div>
    <div class="bl-item"><div class="bl-item-num">67</div><div class="bl-item-content">Sign Language</div></div>
  </div>
  <p class="bl-note">Indian languages (Reading, Writing, Speaking)</p>
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">68</div><div class="bl-item-content">Telugu (Mother tongue)</div></div>
    <div class="bl-item"><div class="bl-item-num">69</div><div class="bl-item-content">Tamil</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">70</div><div class="bl-item-content">Attend a live concert (Shaan)<span class="bl-item-date">2010</span></div></div>
    <div class="bl-item done"><div class="bl-item-num">71</div><div class="bl-item-content">Attend live orchestra / Opera (Budapest)<span class="bl-item-date">2012</span></div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">72</div><div class="bl-item-content">Bear Grylls</div></div>
    <div class="bl-item"><div class="bl-item-num">73</div><div class="bl-item-content">Hrithik Roshan</div></div>
    <div class="bl-item"><div class="bl-item-num">74</div><div class="bl-item-content">Rafa Nadal</div></div>
    <div class="bl-item"><div class="bl-item-num">75</div><div class="bl-item-content">Rahul Dravid</div></div>
    <div class="bl-item"><div class="bl-item-num">76</div><div class="bl-item-content">Abhinav Bindra</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">77</div><div class="bl-item-content">Vipassana 10 days meditation retreat<span class="bl-item-date">2012</span></div></div>
    <div class="bl-item"><div class="bl-item-num">78</div><div class="bl-item-content">Volunteer for an NGO</div></div>
    <div class="bl-item done"><div class="bl-item-num">79</div><div class="bl-item-content">Support a kid's education<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">80</div><div class="bl-item-content">Make a difference in someone's life</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">81</div><div class="bl-item-content">Get a PhD (TU Darmstadt)<span class="bl-item-date">2019</span></div></div>
    <div class="bl-item done"><div class="bl-item-num">82</div><div class="bl-item-content">Start a personal website/blog<span class="bl-item-date">2013</span></div></div>
    <div class="bl-item"><div class="bl-item-num">83</div><div class="bl-item-content">Start a business</div></div>
    <div class="bl-item"><div class="bl-item-num">84</div><div class="bl-item-content">Give a TED Talk</div></div>
    <div class="bl-item"><div class="bl-item-num">85</div><div class="bl-item-content">Give a keynote speech</div></div>
    <div class="bl-item"><div class="bl-item-num">86</div><div class="bl-item-content">Mentor someone to success</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item"><div class="bl-item-num">87</div><div class="bl-item-content">Own SFH in California</div></div>
    <div class="bl-item"><div class="bl-item-num">88</div><div class="bl-item-content">Own SFH in Bogota</div></div>
    <div class="bl-item"><div class="bl-item-num">89</div><div class="bl-item-content">Own SFH in Hawaii</div></div>
    <div class="bl-item"><div class="bl-item-num">90</div><div class="bl-item-content">Own SFH in Florida</div></div>
    <div class="bl-item"><div class="bl-item-num">91</div><div class="bl-item-content">Own SFH in Spain</div></div>
    <div class="bl-item"><div class="bl-item-num">92</div><div class="bl-item-content">Own a Mercedes Camper Van</div></div>
    <div class="bl-item"><div class="bl-item-num">93</div><div class="bl-item-content">Own an Indian Cruiser Bike</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">94</div><div class="bl-item-content">Fly Business Class<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">95</div><div class="bl-item-content">Fly First Class</div></div>
    <div class="bl-item"><div class="bl-item-num">96</div><div class="bl-item-content">Fly Private Jet</div></div>
  </div>
</div>
...
<div class="bl-section">
  ...
  <div class="bl-items">
    <div class="bl-item done"><div class="bl-item-num">97</div><div class="bl-item-content">Permanent Tattoo<span class="bl-item-date">Done</span></div></div>
    <div class="bl-item"><div class="bl-item-num">98</div><div class="bl-item-content">100 Books project <span class="bl-item-date">6 so far</span></div></div>
    <div class="bl-item"><div class="bl-item-num">99</div><div class="bl-item-content">100 Strangers Project</div></div>
    <div class="bl-item"><div class="bl-item-num">100</div><div class="bl-item-content">100 Immigrant Stories Project</div></div>
    <div class="bl-item"><div class="bl-item-num">101</div><div class="bl-item-content">Publish a book</div></div>
    <div class="bl-item"><div class="bl-item-num">102</div><div class="bl-item-content">Get a photograph published</div></div>
    <div class="bl-item"><div class="bl-item-num">103</div><div class="bl-item-content">Get an article published</div></div>
    <div class="bl-item"><div class="bl-item-num">104</div><div class="bl-item-content">Financially independent by 45</div></div>
  </div>
</div>
